...
const page = (props: Props) => {
  return (
    <MaxWidthWrapper className="py-10">
      <h1 className="font-bold text-5xl font-boska mb-6">Privacy Policy</h1>
      ...
      <h2 className="font-bold text-3 mb-2">Interpretation and Definitions</h2>
      <h3 className="font-bold text-3">Interpretation</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to Srebro Lepic, 74254 Novi Seher.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Srebro Lepic, accessible from
          srebrolepic.com
        </li>
        <li>
      ...
      <h3 className="font-bold text-3">Types of Data Collected</h3>
      <h4>Personal Data</h4>
      <p>
      ...
      <h3 className="font-bold text-3">Use of Your Personal Data</h3>
      ...
      <h3 className="font-bold text-3">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="font-bold text-3">Security of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Children&apos;s Privacy</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Links to Other Websites</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Changes to this Privacy Policy</h3>
      <p>
      ...
      <h3 className="font-bold text-3">Contact Us</h3>
      <p>
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li>By email: Lepic.elvedin@hotmail.com</li>
        <li>By phone number: +387 63 670 155</li>
      </ul>
    </MaxWidthWrapper>
  );
};
